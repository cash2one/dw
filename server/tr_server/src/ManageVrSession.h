...
public:
	...
	int handleMsgCancelMatchReq(InterPacket * input_packet, const EmptyMsg * input_msg);
	int handleProtoPlayer(InterPacket * input_packet, const ProtoAgentMsg * input_msg);
	int handlePlayerOffline(InterPacket * input_packet, const EmptyMsg * input_msg);
	int handleSMsgVrReciveBattleReportNotifyBattle(InterPacket * input_packet, const EmptyMsg * input_msg);
protected:
