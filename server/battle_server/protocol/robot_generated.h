...
struct DemoSystemTestReq;
struct DemoSystemTestAck;
...
struct DemoSystemTestReq FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  int32_t you() const { return GetField<int32_t>(4, 0); }
  const flatbuffers::String *her() const { return GetPointer<const flatbuffers::String *>(6); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, 4 /* you */) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* her */) &&
           verifier.Verify(her()) &&
           verifier.EndTable();
  }
};

struct DemoSystemTestReqBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_you(int32_t you) { fbb_.AddElement<int32_t>(4, you, 0); }
  void add_her(flatbuffers::Offset<flatbuffers::String> her) { fbb_.AddOffset(6, her); }
  DemoSystemTestReqBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  DemoSystemTestReqBuilder &operator=(const DemoSystemTestReqBuilder &);
  flatbuffers::Offset<DemoSystemTestReq> Finish() {
    auto o = flatbuffers::Offset<DemoSystemTestReq>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<DemoSystemTestReq> CreateDemoSystemTestReq(flatbuffers::FlatBufferBuilder &_fbb,
   int32_t you = 0,
   flatbuffers::Offset<flatbuffers::String> her = 0) {
  DemoSystemTestReqBuilder builder_(_fbb);
  builder_.add_her(her);
  builder_.add_you(you);
  return builder_.Finish();
}

struct DemoSystemTestAck FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  uint8_t me() const { return GetField<uint8_t>(4, 0); }
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *one() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(6); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, 4 /* me */) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* one */) &&
           verifier.Verify(one()) &&
           verifier.VerifyVectorOfStrings(one()) &&
           verifier.EndTable();
  }
};

struct DemoSystemTestAckBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_me(uint8_t me) { fbb_.AddElement<uint8_t>(4, me, 0); }
  void add_one(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> one) { fbb_.AddOffset(6, one); }
  DemoSystemTestAckBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  DemoSystemTestAckBuilder &operator=(const DemoSystemTestAckBuilder &);
  flatbuffers::Offset<DemoSystemTestAck> Finish() {
    auto o = flatbuffers::Offset<DemoSystemTestAck>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<DemoSystemTestAck> CreateDemoSystemTestAck(flatbuffers::FlatBufferBuilder &_fbb,
   uint8_t me = 0,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> one = 0) {
  DemoSystemTestAckBuilder builder_(_fbb);
