...
bool getAttrValue(Element * element, const string & attr_name, Uint32Vec_t & attr_value, const char * split_token = ";");

bool getAttrValue(Element * element, const string & attr_name, Int32Vec_t & attr_value, const char * split_token = ";");

bool getAttrValue(Element * element, const string & attr_name, Uint32Set_t & attr_value, const char * split_token = ";");

bool getAttrValue(Element * element, const string & attr_name, Uint64Vec_t & attr_value, const char * split_token = ";");
