...
int Convert::utf8ToUnicode(wchar_t* outBuff, int buffSize, const char* text, int textSize)
{
#ifdef _WIN32
...
int Convert::utf8ToUnicode(std::wstring& outBuff, const std::string& text)
{
#ifdef _WIN32
...
int Convert::unicodeToUTF8(char* outBuff, int buffSize, const wchar_t* text, int textSize)
{
#ifdef _WIN32
...
int Convert::unicodeToUTF8(std::string& outBuff, const std::wstring& text)
{
#ifdef _WIN32
...
int Convert::unicodeToGB2312(char* outBuff, int buffSize, const wchar_t* text, int textSize)
{
#ifdef _WIN32
...
int Convert::unicodeToGB2312(std::string& outBuff, const std::wstring& text)
{
#ifdef _WIN32
...
int Convert::gb2312ToUnicode(wchar_t* outBuff, int buffSize, const char* text, int textSize)
{
#ifdef _WIN32
...
int Convert::gb2312ToUnicode(std::wstring& outBuff, const std::string& text)
{
#ifdef _WIN32
...
int Convert::gb2312ToUTF8(char* outBuff, int buffSize, const char* text, int textSize)
{
	std::wstring unicode;
	std::string  txt;
...
int Convert::gb2312ToUTF8(std::string& outBuff, const std::string& text)
{
	std::wstring unicode;
...
int Convert::utf8ToGB2312(char* outBuff, int buffSize, const char* text, int textSize)
{
	std::wstring unicode;
	std::string  txt;
	for (int i=0; text[i] && i < textSize; ++i) {
...
int Convert::utf8ToGB2312(std::string& outBuff, const std::string& text)
{
	std::wstring unicode;
...
std::string Convert::toStringA(const int32 n)
{
...
std::string Convert::toStringA(const uint32 n)
{
	char buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::string Convert::toStringA(const int64 n)
{
	char buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::string Convert::toStringA(const uint64 n)
{
	char buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::string Convert::toStringA(const float f)
{
	char buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::string Convert::toStringA(const double d)
{
	char buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::wstring Convert::toStringW(const int32 n)
{
...
std::wstring Convert::toStringW(const uint32 n)
{
	wchar_t buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::wstring Convert::toStringW(const int64 n)
{
	wchar_t buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::wstring Convert::toStringW(const uint64 n)
{
	wchar_t buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::wstring Convert::toStringW(const float f)
{
	wchar_t buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
std::wstring Convert::toStringW(const double d)
{
	wchar_t buffer[BSLIB_UTILITY_DATA_MAX] = {0};
...
int32  Convert::toInt32(const std::wstring& str)
{
#ifdef _WIN32
...
uint32 Convert::toUint32(const std::wstring& str)
{
#ifdef _WIN32
...
int64  Convert::toInt64(const std::wstring& str)
{
#ifdef _WIN32
...
uint64 Convert::toUint64(const std::wstring& str)
{
#ifdef _WIN32
...
float  Convert::toFloat(const std::wstring& str)
{
#ifdef _WIN32
...
double Convert::toDouble(const std::wstring& str)
{
#ifdef _WIN32
